...
const getPhotoSet = _ => {
  return [
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316612/DSCN0003_jnuc3p.jpg',
      width: 900,
      height: 600,
      aspectRatio: 1.5,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316611/sc000c40f3_hn5k9x.jpg',
      width: 600,
      height: 900,
      aspectRatio: .75,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316610/sc000c1d7a_pisxm4.jpg',
      width: 900,
      height: 600,
      aspectRatio: 1.4,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316609/sc000b87f1_ha3edc.jpg',
      width: 600,
      height: 900,
      aspectRatio: .75,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316608/sc000b6d00_a2zmhm.jpg',
      width: 600,
      height: 900,
      aspectRatio: .75,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316607/sc000a02b1_bp5rvf.jpg',
      width: 900,
      height: 600,
      aspectRatio: 1.5,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316606/sc0000aea5_m3tgui.jpg',
      width: 900,
      height: 600,
      aspectRatio: 1.3,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316606/sc000af309_wv9oqk.jpg',
      width: 900,
      height: 600,
      aspectRatio: 1.4,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316604/DSC00080_t15hcb.jpg',
      width: 600,
      height: 900,
      aspectRatio: .75,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316603/DSC00044_ujmiww.jpg',
      width: 600,
      height: 900,
      aspectRatio: .75,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316603/DSC00053_x9w3dr.jpg',
      width: 900,
      height: 600,
      aspectRatio: 1.4,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316603/DSC00036_dgirxn.jpg',
      width: 600,
      height: 900,
      aspectRatio: .75,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316603/DSC00043_bhzkiu.jpg',
      width: 900,
      height: 600,
      aspectRatio: 1.3,
      lightboxImage:{
    ...
    {
      src: 'https://res.cloudinary.com/devmatto/image/upload/v1486316603/DSC00017_inxt6g.jpg',
      width: 900,
      height: 600,
      aspectRatio: 1.3,
      lightboxImage:{
